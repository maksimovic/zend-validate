...
class Zend_Validate_DateTest extends TestCase
{
    ...
    {
        $this->markTestSkipped('Requires zend-date and zend-locale packages');
     ...
     * @return void
     */
    public function testCharactersTrailingInvalid(): void
    {
     ...
     * @return void
     */
    public function testCharactersLeadingInvalid(): void
    {
        $dateValid = '2007-08-02';
     ...
     * @return void
     */
    public function testUseLocaleFormat(): void
    {
     ...
     * @return void
     */
    public function testLocaleContructor(): void
    {
        set_error_handler(array($this, 'errorHandlerIgnore'));
     ...
     * ZF-7630
     */
    public function testDateObjectVerification(): void
    {
        $date = new Zend_Date();
     ...
     * ZF-6457
     */
    public function testArrayVerification(): void
    {
        $date  = new Zend_Date();
        $array = $date->toArray();
