...
class Zend_Validate_NotEmptyTest extends TestCase
{
     ...
     * @return void
     */
    public function testOnlyBoolean(): void
    {
     ...
     * @return void
     */
    public function testOnlyInteger(): void
    {
     ...
     * @return void
     */
    public function testOnlyFloat(): void
    {
     ...
     * @return void
     */
    public function testOnlyString(): void
    {
     ...
     * @return void
     */
    public function testOnlyZero(): void
    {
     ...
     * @return void
     */
    public function testOnlyArray(): void
    {
     ...
     * @return void
     */
    public function testOnlyPHP(): void
    {
     ...
     * @return void
     */
    public function testOnlySpace(): void
    {
     ...
     * @return void
     */
    public function testOnlyAll(): void
    {
     ...
     * @return void
     */
    public function testArrayConstantNotation(): void
    {
     ...
     * @return void
     */
    public function testArrayConfigNotation(): void
    {
        $filter = new Zend_Validate_NotEmpty(
            array(
                'type' => array(
     ...
     * @return void
     */
    public function testMultiConstantNotation(): void
    {
        $filter = new Zend_Validate_NotEmpty(
     ...
     * @return void
     */
    public function testStringNotation(): void
    {
        $filter = new Zend_Validate_NotEmpty(
            array(
     ...
     * @return void
     */
    public function testSingleStringNotation(): void
    {
        $filter = new Zend_Validate_NotEmpty(
            'boolean'
        );
    ...
    {
        $this->markTestSkipped('Requires zend-config package');
     ...
     * @return void
     */
    public function testZF8767(): void
    {
