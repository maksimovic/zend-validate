...
class Zend_Validate_HostnameTest extends TestCase
{
     ...
     *
     */
    public function testDashes(): void
    {
        $valuesExpected = array(
     ...
     *
     */
    public function testValidatorHandlesUnderscoresInDomainsWithoutTldCheckCorrectly(): void
    {
        $valuesExpected = array(
            array(Zend_Validate_Hostname::ALLOW_DNS, true, array(
                '_subdomain.domain.com', 'subdomain_.domain.com', 'sub_domain.domain.com', 'sub__domain.domain.com'
     ...
     *
     */
    public function testRessourceIDN(): void
    {
        $validator = new Zend_Validate_Hostname();
     ...
     * @group ZF-6033
     */
    public function testNumberNames(): void
    {
        $validator = new Zend_Validate_Hostname();
     ...
     * @group ZF-6133
     */
    public function testPunycodeDecoding(): void
    {
        $validator = new Zend_Validate_Hostname();
     ...
     * @group ZF-7277
     */
    public function testDifferentIconvEncoding(): void
    {
        if (PHP_VERSION_ID < 50600) {
     ...
     * @ZF-12314
     */
    public function testDKSpecialChars(): void
    {
     ...
     * test for IDN CA
     */
    public function testIDNCA(): void
    {
        $validator = new Zend_Validate_Hostname(Zend_Validate_Hostname::ALLOW_ALL);
     ...
     * @group ZF-12413
     */
    public function testIDNUA(): void
    {
        $validator = new Zend_Validate_Hostname(Zend_Validate_Hostname::ALLOW_ALL);
     ...
     * @group GH-115
     */
    public function testIDNRS(): void
    {
        $validator = new Zend_Validate_Hostname(Zend_Validate_Hostname::ALLOW_ALL);
     ...
     * @group GH-19
     */
    public function testRussianIdn(): void
    {
        $validator = new Zend_Validate_Hostname();
     ...
     * @group GH-610
     */
    public function testGermanSmallLetterSharpS(): void
    {
        $validator = new Zend_Validate_Hostname();
     ...
     * @group GH-612
     */
    public function testZeroSubdomain(): void
    {
        $validator = new Zend_Validate_Hostname();
