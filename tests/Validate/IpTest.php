...
class Zend_Validate_IpTest extends TestCase
{
    /**
    ...
    public function testZeroIpForZF2420(): void
    {
    ...
    public function testInvalidIpForZF4809(): void
    {
        $this->assertFalse($this->_validator->isValid('1.2.333'));
    }

    public function testInvalidIpForZF3435(): void
    {
