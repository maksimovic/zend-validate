...
class Zend_Validate_FloatTest extends TestCase
{
     ...
     * @ZF-7987
     */
    public function testNoZendLocaleButPhpLocale(): void
    {
     ...
     * @ZF-7987
     */
    public function testLocaleDeFloatType(): void
    {
        $this->_validator->setLocale('de');
        $this->assertEquals('de', $this->_validator->getLocale());
        $this->assertEquals(true, $this->_validator->isValid(10.5));
     ...
     * @ZF-7987
     */
    public function testPhpLocaleDeFloatType(): void
    {
        $locale = setlocale(LC_ALL, 0);
        setlocale(LC_ALL, 'de');
        $valid = new Zend_Validate_Float();
     ...
     * @ZF-7987
     */
    public function testPhpLocaleFrFloatType(): void
    {
        $locale = setlocale(LC_ALL, 0);
        setlocale(LC_ALL, 'fr');
        $valid = new Zend_Validate_Float();
     ...
     * @ZF-8919
     */
    public function testPhpLocaleDeStringType(): void
    {
     ...
     * @ZF-8919
     */
    public function testPhpLocaleFrStringType(): void
    {
     ...
     * @ZF-8919
     */
    public function testPhpLocaleEnStringType(): void
    {
